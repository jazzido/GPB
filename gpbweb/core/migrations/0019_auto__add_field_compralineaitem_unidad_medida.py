...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'CompraLineaItem.unidad_medida'
        db.add_column('core_compralineaitem', 'unidad_medida', self.gf('django.db.models.fields.CharField')(max_length=64, null=True, blank=True), keep_default=False)


    def backwards(self, orm):
        
        # Deleting field 'CompraLineaItem.unidad_medida'
        db.delete_column('core_compralineaitem', 'unidad_medida')
    ...
    models = {
        ...
        'core.compralineaitem': {
            ...
            'unidad_medida': ('django.db.models.fields.CharField', [], {'max_length': '64', 'null': 'True', 'blank': 'True'})
        },
        'core.proveedor': {
            ...
            'nombre_fantasia': ('django.db.models.fields.TextField', [], {'null': 'True', 'blank': 'True'}),
