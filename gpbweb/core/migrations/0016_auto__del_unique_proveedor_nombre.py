...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Removing unique constraint on 'Proveedor', fields ['nombre']
        db.delete_unique('core_proveedor', ['nombre'])


    def backwards(self, orm):
        
        # Adding unique constraint on 'Proveedor', fields ['nombre']
        db.create_unique('core_proveedor', ['nombre'])
