...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        db.execute("UPDATE core_proveedor SET search_index=to_tsvector('spanish', nombre);")
        db.execute("UPDATE core_reparticion SET search_index=to_tsvector('spanish', nombre);")
