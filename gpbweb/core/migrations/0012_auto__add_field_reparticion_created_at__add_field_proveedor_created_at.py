...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Reparticion.created_at'
        db.add_column('core_reparticion', 'created_at', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True), keep_default=False)

        # Adding field 'Proveedor.created_at'
        db.add_column('core_proveedor', 'created_at', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True), keep_default=False)

        # Adding field 'Compra.created_at'
        db.add_column('core_compra', 'created_at', self.gf('django.db.models.fields.DateTimeField')(default=datetime.datetime.now, blank=True), keep_default=False)
    
    
    def backwards(self, orm):
        
        # Deleting field 'Reparticion.created_at'
        db.delete_column('core_reparticion', 'created_at')

        # Deleting field 'Proveedor.created_at'
        db.delete_column('core_proveedor', 'created_at')

        # Deleting field 'Compra.created_at'
        db.delete_column('core_compra', 'created_at')
